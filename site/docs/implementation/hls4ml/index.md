...
| 11. ENABOL bridge | Write dataset/testbench export for trainable CSIM. | [HLS4ML-012](/docs/status/tasks?query=HLS4ML-012) / [HLS4ML-020](/docs/status/tasks?query=HLS4ML-020) | `enabol/dataset.py`, `vivado_writer.py` | CSIM receives inputs, ground truth, epoch/shuffle settings, and a generated `trainable_loss.log` for first firmware validation. |
