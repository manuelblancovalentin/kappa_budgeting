...
| EXP-000B | [One-layer global throttle with quantization](./exp-000b-global-throttle-qfx-lin1.md) | <Badge status="preliminary" /> | [`DS-AFFINE-LINEAR-000`](../datasets/affine-linear-000.md) | [`MDL-DENSE1-LINEAR-NOBIAS-000`](../models/dense1-linear-nobias-000.md) | `.../exp_000_global_throttle_sanity` | Does throttling still help when the one-layer loop includes fake-fixed-point weights, updates, activations, and rails? |
