...
| ID | Name | Status | Dataset ID | Model ID | Workspace<br/> `workspace/ablations` | Main Question |
|---|---|:---:|---|---|---|---|
| EXP-000A | [One-layer global throttle sanity check](./exp-000a-global-throttle-float-lin1.md) | <Badge status="valid" /> | [`DS-AFFINE-LINEAR-000`](../datasets/affine-linear-000.md) | [`MDL-DENSE1-LINEAR-NOBIAS-000`](../models/dense1-linear-nobias-000.md) | [`.../exp_000_global_throttle_sanity`](https://github.com/manuelblancovalentin/kappa_budgeting/blob/102be154f09eef96536ea3dc6ca5ec7a16756979/workspace/ablations/exp_000_global_throttle_sanity) | Can a global controller throttle the total learning rate and prevent one-layer divergence? |
| EXP-000B | [One-layer global throttle with quantization](./exp-000b-global-throttle-qfx-lin1.md) | <Badge status="valid" /> | [`DS-AFFINE-LINEAR-000`](../datasets/affine-linear-000.md) | [`MDL-DENSE1-LINEAR-NOBIAS-000`](../models/dense1-linear-nobias-000.md) | `.../exp_000_global_throttle_sanity` | Does throttling still help when the one-layer loop includes fake-fixed-point weights, updates, activations, and rails? |
| EXP-001 | [Global throttle parameter sweep](./exp-001-global-throttle-parameter-sweep) | <Badge status="valid" /> | [`DS-AFFINE-LINEAR-000`](../datasets/affine-linear-000.md) | [`MDL-DENSE1-LINEAR-NOBIAS-000`](../models/dense1-linear-nobias-000.md) | `.../exp_001_lin1_stability_phase_diagram` | How does the stability region and controller behavior change as we sweep drift parameters? |
| CSIM-001 | [One-layer no controller sanity check in csim](./csim-001-global-throttle-csim-sanity) | <Badge status="valid" /> | [`DS-AFFINE-LINEAR-000`](../datasets/affine-linear-000.md) | [`MDL-DENSE1-LINEAR-NOBIAS-000`](../models/dense1-linear-nobias-000.md) | `.../csim_001_global_throttle_csim_sanity` | Can we synthesize and run training for the simplest case? |
| EXP-001A | One-layer no-bias float scale drift | <Badge status="planned" /> | `DS-AFFINE-LINEAR-000` | `MDL-DENSE1-LINEAR-NOBIAS-000` | [notes.md](https://github.com/manuelblancovalentin/kappa_budgeting/blob/master/workspace/ablations/001a_one_layer_no_bias_float_scale_drift/notes.md) | Does the controller enforce the known Hessian stability boundary under pure scale drift? |
| EXP-001B | One-layer fake fixed-point rails | <Badge status="planned" /> | `DS-AFFINE-LINEAR-000` | `MDL-DENSE1-LINEAR-NOBIAS-000` | TBD | Does throttling still help when instability is caused by quantization and saturation? |
| EXP-002A | Two-layer linear network | <Badge status="planned" /> | TBD | TBD | TBD | Can global throttling stabilize inter-layer coupling without activation nonlinearities? |
| EXP-002B | Two-layer ReLU teacher/student | <Badge status="planned" /> | TBD | TBD | [notes.md](https://github.com/manuelblancovalentin/kappa_budgeting/blob/master/workspace/ablations/002_two_layer_relu/notes.md) | Can global throttling stabilize coupled nonlinear layer dynamics without rotating the update? |
...
| Step | Goal | Adds |
|---|---|---|
| EXP-000 | Sanity-check instrumentation and controller | One layer, no bias, float, exploratory drift. |
| EXP-000B | Add the first fake-fixed-point path | Quantized weights, updates, activations, saturation counters, and update underflow checks. |
| EXP-001A | Clean curvature-only stability test | Pure scale drift, Hessian-selected learning rates. |
| EXP-001B | Numerical hardware-style failure | Fake fixed-point quantization, rails, saturation counters. |
