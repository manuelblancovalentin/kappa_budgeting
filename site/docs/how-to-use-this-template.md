...
This repository is a reusable lab project logbook.

Use it when starting a new project, prototype, paper-support repo, hardware experiment, or student handoff.
...
## Minimal weekly habit

Each active contributor should write either:

- one GitHub issue using the Weekly Log template, or
- one short lab log entry in `blog/`.

The goal is not beautiful prose. The goal is recoverable project memory.